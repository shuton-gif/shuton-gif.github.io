...
Looking back, I find it interesting that I started this project thinking it was mostly about colors, spacing, and layout. But by the end, I realized I had been learning something deeper. Design patterns are not just fancy names for code tricks. They are shared ways of thinking that help people solve the same kinds of problems without starting from zero every time. Without trying to, I ended up using several patterns in my final project, reusable components, reactive updates, centralized state, and dynamic UI creation. The title of this essay, “The Art of Drawing with Others,” makes more sense to me now. At the start, I was drawing alone. By the end, I was drawing with rules that many other developers already understand. And that, to me, is what design patterns really are.
