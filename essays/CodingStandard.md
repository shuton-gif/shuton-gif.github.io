...
<img class="img-fluid" src="../img/codingStandard/BadTypeScript.png" style="height: 20%;">
...
<img class="img-fluid" src="../img/codingStandard/climber.png" style="height: 40%;">

**There's a BackPackStore that sells BackPack objects with pickaxes and water.**

<img class="img-fluid" src="../img/codingStandard/Store.png" style="height: 40%;">

**Then it is more intuitive that the store is declaring the Objects.**

<img class="img-fluid" src="../img/codingStandard/newClimbing.png" style="height: 40%;">

**Then you need a climbUp() function to go up.**
<div style="display: flex; gap: 1rem;">
    <img class="img-fluid" src="../img/codingStandard/final.png" style="max-width: 25%, height: 40%;">
    <img class="img-fluid" src="../img/codingStandard/finalStore.png" style="max-width: 25%, height: 40%;">
</div>
