...
<img class="img-fluid" src="../img/codingStandard/BadTypeScript.png" style="height: 50rem; margin-left: auto; margin-right: auto; display: block;">
...
<img class="img-fluid" src="../img/codingStandard/Store.png" style="height: 50rem; margin-left: auto; margin-right: auto; display: block;">

**Then it is more intuitive that the store is declaring the Objects.**

<img class="img-fluid" src="../img/codingStandard/newClimbing.png" style="height: 50rem; margin-left: auto; margin-right: auto; display: block;">

**Then you need a climbUp() function to go up.**
<div style="display: flex; gap: 1rem;">
    <img class="img-fluid" src="../img/codingStandard/final.png" style="height: 30rem; margin-left: auto; margin-right: auto;">
    <img class="img-fluid" src="../img/codingStandard/finalStore.png" style="height: 30rem; margin-left: auto; margin-right: auto;">
</div>
